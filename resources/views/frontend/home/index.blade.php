            ...
            <div class="core-slider_viewport">
                <div class="core-slider_list">
                    ...
                    <div class="core-slider_item">
                        <img src="{{asset('/Slider/'.$slider->slider)}}" class="img-responsive" alt="">
                    </div>
                    @endforeach
                    ...
                    <div class="col-md-3 arrival-grid simpleCart_shelfItem">
                        <div class="grid-arr">
                            <div  class="grid-arrival">
                                <figure>
                                    <a href="{{url('/product/details'.$product->id)}}" class="new-gri" data-toggle="modal" data-target="#myModal1">
                                        <div class="grid-img">
                            ...
                            <div class="block ">
                                ...
                                <div class="women">
                                    ...
                                    @else
                                    <a href="{{ url('/user/login') }}" data-text="Add To Cart" class="my-cart-b item_add">Add To Cart</a>
                                    @endif
                                    </div>
                              </form>
                            </div>
