...
<main class="content_vendor_login ">
    ...
    <form action="{{ url('/vendor/login') }}" id="login-form" method="post">
        @csrf
    ...
    <form action="{{ url('/vendor/registration') }}" id="register-form" class="hidden" method="post" enctype="multipart/form-data">
        @csrf
